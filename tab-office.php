...
<body class="bg">
  ...
  <div class="admincard">
    ...
    <div id="Add" class="tabcontent">
      ...
      <br>
      <form action="add-office-php.php" method="post">
        <ul class="form-style">
  ...
  <div id="Update" class="tabcontent">
    <form action="update-search-office.php" method="post">
      <ul class="form-style">
        <li>
  ...
  # code...
    ...
    <div class="update-form" id="update-form">
      <form action="update-office-php.php" method="post">
        <ul class="form-style">
          <li><label>Full Name <span class="required">*</span></label>
...
<div id="Delete" class="tabcontent">
  <form action="delete-search-office.php" method="post">
    <ul class="form-style">
      <li>
        <label>User ID <span class="required">*</span></label>
        <input type="text" name="uname" placeholder="User ID" required="required"/>
...
# code...
  ...
  <div class="delete-form" id="delete-form">
    <form action="delete-office-php.php" method="post">
