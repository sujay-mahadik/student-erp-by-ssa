...
<body class="bg">
  ...
  <br>
  <br>
  <div class="tab-content" style="visibility: <?php echo $_SESSION['found'];?>">
      <form action="update-student-php.php" method="post">
        <ul class="form-style">

          <li><label>Full Name <span class="required">*</span></label>
            <input type="text" name="ufirstname" class="field-divided" value="<?php echo $_SESSION['ufname']; ?>" />
            <input type="text" name="umiddlename" class="field-divided" value="<?php echo $_SESSION['umname']; ?>" />
            <input type="text" name="ulastname" class="field-divided" value="<?php echo $_SESSION['ulname']; ?>" />
          </li>
          <li>
            <label>Email <span class="required">*</span></label>
